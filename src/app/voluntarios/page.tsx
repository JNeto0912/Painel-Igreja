      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-yellow-50 border border-yellow-300 rounded-xl p-4 mb-6">
          ...
          <p className="text-yellow-700 text-sm">
            Esta lista reúne irmãos que desejam se voluntariar em áreas da igreja.
            O contato é feito diretamente entre as partes, sem intermediação da liderança.
          </p>
        </div>
              ...
              <div key={v.id} className="bg-white rounded-xl shadow px-4 py-4">
                <div className="flex items-start justify-between gap-3">
                  <div>
                    ...
                    {v.dons && (
                      <p className="text-zinc-500 text-sm mt-2">Dons: {v.dons}</p>
                    )}
